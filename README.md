...
Browser trainer for dice-game neural nets (Yahtzee, Farkle, 6 Cubes, Goblin Gamble). Select one or more games via checkboxes to cross-train a shared policy. Runs locally (or on GitHub Pages); no server required.
